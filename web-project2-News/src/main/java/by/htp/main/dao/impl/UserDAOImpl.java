...
public class UserDAOImpl implements UserDAO {
	...
	public static boolean checkPassword(String passwordPlaintext, String storedHash) {
		...
		// systems including some Linux distributions such as SUSE Linux.[2]
		// The prefix "$2a$" or "$2b$" (or "$2y$") in a hash string in a shadow password
		// file indicates that hash string is a bcrypt hash in modular crypt format.[3]
		// The rest of the hash string includes the cost parameter, a 128-bit salt
		// (base-64 encoded as 22 characters), and
